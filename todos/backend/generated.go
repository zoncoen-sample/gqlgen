...
func (ec *executionContext) _ToggleTodoPayload_id(ctx context.Context, field graphql.CollectedField, obj *models.ToggleTodoPayload) (ret graphql.Marshaler) {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
...
func (ec *executionContext) _ToggleTodoPayload_done(ctx context.Context, field graphql.CollectedField, obj *models.ToggleTodoPayload) (ret graphql.Marshaler) {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
